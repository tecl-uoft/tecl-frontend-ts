  ...
  return (
    <div className="container px-2 pt-4 mx-auto">
      ...
      <div className="flex flex-wrap mb-16 text-gray-800 fair-study">
        ...
        <div onClick={props.onClickPic} className="w-full px-2 text-gray-800 bg-white rounded-lg md:w-1/2 hover:bg-gray-100 focus:outline-none hover:text-orange-500">
